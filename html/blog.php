                    ...
                    <div class="d-flex justify-content-end">
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item ms-3"><a href="../html/blog.php" class="nav-link active" aria-current="page">Blog</a></li>
        ...
        <div class="container my-5">
            <div class="d-flex flex-wrap-mobile border w-75 mx-auto">
                ...
                <div class="">
                    ...
                    <div class="me-5">
                       <a href="../html/article-blog.php" class="fs-4 text-decoration-none text-black">Coup de projecteur sur le parcours <br> entrepreneuriat de la Formation Solaire à Energy Generation</a>
                       <br> <br>
                        ...
                        <div class="d-flex flex-wrap justify-content-between">
                            <div>
                                <span>226vues</span>
                                <a href="../html/article-blog.php" class="ms-md-5 text-decoration-none text-black ">
