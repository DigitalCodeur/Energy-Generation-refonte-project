                ...
                <div class="d-flex justify-content-end">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item ms-3"><a href="../php/devenir_mentor.php" class="nav-link active" aria-current="page">Devenir Mentor</a></li>
                  ...
                  <div class="carousel-item active">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            ...
                            <button type="button" onclick="window.location.href ='../php/formulaire-mentorat.php'" class="btn btn-primary fs-4 p-3 mb-titre" data-bs-toggle="button">DEVENEZ MENTOR</button>
                        </div>
                    </div>
                  </div>
                  ...
                  <div class="carousel-item">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            ...
                            <button type="button" onclick="window.location.href ='../php/formulaire-mentorat.php'" class="btn btn-primary rounded-3 fs-4 p-3 mb-titre" data-bs-toggle="button">DEVENEZ MENTOR</button>
                        </div>
                    </div>
                  </div>
                </div>
